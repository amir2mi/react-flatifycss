...
const ComponentTemplate: Story = args => {
  const [active, setActive] = useState('first');

  return (
    <ItemsGroup {...args} value={active} onChange={value => setActive(value)}>
      <Item
        title="First Item"
        subtitle="Lorem ipsum dolor sit amet."
        value="first"
...
const CustomTemplate: Story = args => {
  ...
  return (
    <ItemsGroup
      ...
      onChange={value => setActive(value)}
      theme="purple"
      sx="padding: 10px; background: #F2DEFF !important; border-radius: 1em"
    >
      <Item
        title="First Item"
        subtitle="Lorem ipsum dolor sit amet."
...
export const WithComponent = ComponentTemplate.bind({});
